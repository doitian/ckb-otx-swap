  ...
  return (
    <HeroSection>
      <div className="text-center">
        <h2 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl dark:text-gray-300">
          Hello
        </h2>
        ...
        <Link
          ...
          href="/assets"
        >
          Go to Assets List <ChevronRightIcon className="w-2.5 h-2.5 inline" />
        </Link>
      </div>
    </HeroSection>
  );
